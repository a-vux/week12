...
VD: script có thể thêm một thẻ HTML mới, hoặc chuỗi nhập vào được hiển thị ngay trên web
...
VD: một trang web cho phép bình luận lên các bài viết, và khi gửi bình luận có request POST như sau:
<p align="center">
